...
class Client
{
    ...
    /*
    * __construct auto-generated by pinpoint-apm/pinpoint-php-aop
    */
    public function __construct(?string $uri = null, array $uriOptions = [], array $driverOptions = [])
    {
        $_pinpoint___construct_var = new \Pinpoint\Plugins\MongoPlugin\MongoPlugin(__METHOD__, $this, $uri, $uriOptions, $driverOptions);
        $_pinpoint___construct_ret = null;
        try {
