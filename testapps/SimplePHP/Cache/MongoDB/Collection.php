...
class Collection
{
    ...
    {
        return ['codec' => $this->codec, 'collectionName' => $this->collectionName, 'databaseName' => $this->databaseName, 'manager' => $this->manager, 'readConcern' => $this->readConcern, 'readPreference' => $this->readPreference, 'typeMap' => $this->typeMap, 'writeConcern' => $this->writeConcern];
    }
    /**
     ...
     * @throws DriverRuntimeException for other driver errors (e.g. connection errors)
     */
    public function __pinpoint__deleteMany($filter, array $options = [])
    {
        $options = $this->inheritWriteOptions($options);
    ...
    public function drop(array $options = [])
    {
        ...
        if (!isset($options['encryptedFields'])) {
            $options['encryptedFields'] = get_encrypted_fields_from_driver($this->databaseName, $this->collectionName, $this->manager) ?? get_encrypted_fields_from_server($this->databaseName, $this->collectionName, $this->manager, $server);
        }
     ...
     * @throws DriverRuntimeException for other driver errors (e.g. connection errors)
     */
    public function __pinpoint__find($filter = [], array $options = [])
    {
        $options = $this->inheritReadOptions($options);
        $options = $this->inheritCodecOrTypeMap($options);
     ...
     * @throws DriverRuntimeException for other driver errors (e.g. connection errors)
     */
    public function __pinpoint__insertOne($document, array $options = [])
    {
        $options = $this->inheritWriteOptions($options);
        $options = $this->inheritCodec($options);
     ...
     * @throws DriverRuntimeException for other driver errors (e.g. connection errors)
     */
    public function __pinpoint__updateOne($filter, $update, array $options = [])
    {
        $options = $this->inheritWriteOptions($options);
    ...
    {
        $options += ['codec' => $this->codec, 'readConcern' => $this->readConcern, 'readPreference' => $this->readPreference, 'typeMap' => $this->typeMap, 'writeConcern' => $this->writeConcern];
    ...
    /*
    * deleteMany auto-generated by pinpoint-apm/pinpoint-php-aop
    */
    public function deleteMany($filter, array $options = [])
    {
        $_pinpoint_deleteMany_var = new \Pinpoint\Plugins\MongoPlugin\MongoPlugin(__METHOD__, $this, $filter, $options);
        $_pinpoint_deleteMany_ret = null;
        try {
            $_pinpoint_deleteMany_var->onBefore();
            $_pinpoint_deleteMany_ret = $this->__pinpoint__deleteMany($filter, $options);
            $_pinpoint_deleteMany_var->onEnd($_pinpoint_deleteMany_ret);
            return $_pinpoint_deleteMany_ret;
        } catch (\Exception $e) {
            $_pinpoint_deleteMany_var->onException($e);
            throw $e;
        }
    }
    /*
    * find auto-generated by pinpoint-apm/pinpoint-php-aop
    */
    public function find($filter = [], array $options = [])
    {
        $_pinpoint_find_var = new \Pinpoint\Plugins\MongoPlugin\MongoPlugin(__METHOD__, $this, $filter, $options);
        $_pinpoint_find_ret = null;
        try {
            $_pinpoint_find_var->onBefore();
            $_pinpoint_find_ret = $this->__pinpoint__find($filter, $options);
            $_pinpoint_find_var->onEnd($_pinpoint_find_ret);
            return $_pinpoint_find_ret;
        } catch (\Exception $e) {
            $_pinpoint_find_var->onException($e);
            throw $e;
        }
    }
    /*
    * insertOne auto-generated by pinpoint-apm/pinpoint-php-aop
    */
    public function insertOne($document, array $options = [])
    {
        $_pinpoint_insertOne_var = new \Pinpoint\Plugins\MongoPlugin\MongoPlugin(__METHOD__, $this, $document, $options);
        $_pinpoint_insertOne_ret = null;
        try {
            $_pinpoint_insertOne_var->onBefore();
            $_pinpoint_insertOne_ret = $this->__pinpoint__insertOne($document, $options);
            $_pinpoint_insertOne_var->onEnd($_pinpoint_insertOne_ret);
            return $_pinpoint_insertOne_ret;
        } catch (\Exception $e) {
            $_pinpoint_insertOne_var->onException($e);
            throw $e;
        }
    }
    /*
    * updateOne auto-generated by pinpoint-apm/pinpoint-php-aop
    */
    public function updateOne($filter, $update, array $options = [])
    {
        $_pinpoint_updateOne_var = new \Pinpoint\Plugins\MongoPlugin\MongoPlugin(__METHOD__, $this, $filter, $update, $options);
        $_pinpoint_updateOne_ret = null;
        try {
            $_pinpoint_updateOne_var->onBefore();
            $_pinpoint_updateOne_ret = $this->__pinpoint__updateOne($filter, $update, $options);
            $_pinpoint_updateOne_var->onEnd($_pinpoint_updateOne_ret);
            return $_pinpoint_updateOne_ret;
        } catch (\Exception $e) {
            $_pinpoint_updateOne_var->onException($e);
            throw $e;
        }
    }
}