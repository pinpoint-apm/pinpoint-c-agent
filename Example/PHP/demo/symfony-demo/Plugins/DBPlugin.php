...
///@hook:Doctrine\DBAL\Driver\PDOConnection::__construct
///@hook:Doctrine\DBAL\Driver\PDOConnection::prepare
class DBPlugin extends Candy
{

    public function onBefore()
    {
        if(strpos($this->apId, "__construct"))
        {
            pinpoint_add_clue("stp",MYSQL);
            $args = $this->args;
            $connectStr = $args[0];
            pinpoint_add_clue("dst",$connectStr);
            return;
        }
