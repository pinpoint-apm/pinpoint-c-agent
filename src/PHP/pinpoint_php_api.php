 ...
 * @return void
 */
function pinpoint_join_cut(array $joinable, callable $onBefore, callable $onEnd, callable $onException)
{
}

/**
 * Summary of pinpoint_get_this
 * class Foo{}
 * 
 * @return object : the same as $this, 
 */
function pinpoint_get_this(): void
{
}