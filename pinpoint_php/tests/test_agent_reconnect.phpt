...
pinpoint.common.CollectorSpanPort=19996
pinpoint.common.CollectorStatIp=127.0.0.1
pinpoint.common.CollectorStatPort=19995
pinpoint.common.CollectorTcpIp=127.0.0.1
pinpoint.common.CollectorTcpPort=19994
...
%s %s [pinpoint] [%d:%d] pinpoint_client.cpp:%d [WARN] PinpointClient connect timeout expiredTime:[1]
%s %s [pinpoint] [%d:%d] pinpoint_client.cpp:%d [WARN] PinpointClient connect timeout expiredTime:[1]
%s %s [pinpoint] [%d:%d] pinpoint_client.cpp:%d [WARN] PinpointClient connect timeout expiredTime:[1]
request shutdown

%s %s [pinpoint] [%d:%d] pinpoint_client.cpp:%d [WARN] PinpointClient connect timeout expiredTime:[1]
%s %s [pinpoint] [%d:%d] executor.cpp:%d [WARN] background task finished